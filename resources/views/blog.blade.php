			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="post">
								<a class="post-img" href="{{$item->slug}}"><img src="{{$item->gambar}}" style="width:360px; ; height: 203.9px" alt=""></a>
								<div class="post-body">
									<div class="post-category">
										<a href="{{$item->slug}}">{{$item->category->name}}</a>
									</div>
									<h3 class="post-title"><a href="{{$item->slug}}">{{$item->judul}}</a></h3>
									<ul class="post-meta">
